...
export default function Page() {
	...
	useEffect(() => {
		...
		fetch(`${process.env.NEXT_PUBLIC_BACKEND}/admin/get-orders`, {
			method: 'GET',
			cache: 'no-store',
			headers: {
	...
	// "id": "-NkWjuzD1RPoOP9HIVu4"
	// "coffees": [
	//     {
	//         "id": "-NjP7UdP_WxVmWiovuBd",
	//         "name": "Ice Latte",
	//         "price": 100,
	//         "quantity": 1,
	//         "size": "tall"
	//     }
	// ],
	// "date": "30/11/2023 19:40:59",
	// "deliver_time": "now",
	// "user_address": "Bagcilar cehennemm",
	// "user_id": "-NjSApqPVizXo3KsjMnm",
	// "user_name": "Ahmet",
	// "user_phone_number": "5548768774",
	// "user_surname": "Yıldız"
	...
	return (
		<div className='flex flex-col items-center justify-start p-4 md:w-full xl:px-28 md:py-4 rounded-lg'>
			...
			{/* Showing coffees */}
			<section className=''>
				<div className='flex justify-center items-center flex-wrap gap-4 max-w-4xl'>
					{items
						.map(
							(
								{
								...
								>
									<div className='py-4'>
										<div className='grid grid-cols-3 gap-x-12 w-full place-content-center'>
											<div className='text-sm font-medium text-gray-700 place-self-center self-center'>
												+{user_phone_number}
											</div>
											<div className=' font-serif font-semibold text-2xl text-gray-800  place-self-center self-center'>
										...
										<div className='grid grid-cols-3 gap-x-12 w-full place-content-center mt-2'>
